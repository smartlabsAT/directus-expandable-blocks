...
// Props interface for configurable logger prefix
interface Props {
  open: boolean;
  ...
  loggerPrefix?: string; // New configurable logger prefix
}
...
const props = withDefaults(defineProps<Props>(), {
  ...
  allowLink: true,
  allowDuplicate: true,
  loggerPrefix: '[ItemSelectorDrawer]'
});

// Create scoped logger with configurable prefix
const logger = createScopedLogger(props.loggerPrefix);
